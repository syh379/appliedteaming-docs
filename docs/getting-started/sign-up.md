...
1. Open the app link you share with them.
2. Choose **Continue with Google**, or enter an **email and password**.
3. First time in? They pick **Create an account**; returning students just **Sign in**.
...
- Accounts are per-student; there's nothing to configure.
